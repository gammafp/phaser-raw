...
export class Config {
    ...
    constructor(config: any = {})
    {
        ...
        let renderConfig = GetValue(config, 'render', null);
        ...
        // if renderType is canvas then show webGL is only supported
        if (this.renderType === CONST.CANVAS) {
            console.warn('WebGL is only supported in the browser. Please use the canvas WebGL renderer.');
        }
        // if (window)
        // {
