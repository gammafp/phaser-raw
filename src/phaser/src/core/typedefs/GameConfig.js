 ...
 * @property {number} [type=CONST.AUTO] - Which renderer to use. Phaser.AUTO, Phaser.CANVAS, Phaser.HEADLESS, Phaser.WEBGL, or Phaser.WEBGPU. AUTO picks WEBGPU if available, then WEBGL, then CANVAS.
