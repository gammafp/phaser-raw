...
export class CameraManager {
     ...
     */
    addExisting(camera: Camera, makeMain?: boolean): Camera | null
    {
        if (makeMain === undefined) { makeMain = false; }
     ...
     */
    getCamera(name: string): Camera | null
    {
        var cameras = this.cameras;
     ...
     */
    getCamerasBelowPointer(pointer: any): Camera[]
    {
        var cameras = this.cameras;
     ...
     */
    remove(camera: Camera | Camera[], runDestroy?: boolean): number
    {
     ...
     */
    render(renderer: any, displayList: any): void
    {
     ...
     */
    getVisibleChildren(children: any[], camera: Camera): any[]
    {
