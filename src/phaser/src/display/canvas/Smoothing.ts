 ...
 */
export const getPrefix = (context: any): string | null =>
{
 ...
 */
export const enable = (context: any): any =>
{
    if (prefix === '')
    {
 ...
 * @return {(CanvasRenderingContext2D|WebGLRenderingContext)} The provided context.
 */
export const disable = (context: any): any =>
{
    if (prefix === '')
    {
        prefix = getPrefix(context) || '';
 ...
 */
export const isEnabled = (context: any): boolean | null =>
{
