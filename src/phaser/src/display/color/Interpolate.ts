 ...
 */
export const RGBWithRGB = (r1: number, g1: number, b1: number, r2: number, g2: number, b2: number, length: number = 100, index: number = 0): any =>
{
 ...
 * @return {Phaser.Types.Display.ColorObject} An object containing the interpolated color values.
 */
export const ColorWithColor = (color1: any, color2: any, length: number = 100, index: number = 0): any =>
{
 ...
 * @return {Phaser.Types.Display.ColorObject} An object containing the interpolated color values.
 */
export const ColorWithRGB = (color: any, r: number, g: number, b: number, length: number = 100, index: number = 0): any =>
{
