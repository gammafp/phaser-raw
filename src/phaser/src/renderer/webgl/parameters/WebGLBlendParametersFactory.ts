 ...
 * @since 4.0.0
 */
export const WebGLBlendParametersFactory = {
    /**
     ...
     * @since 4.0.0
     */
    createCombined (renderer: any, enabled?: boolean, color?: number[], equation?: number, funcSrc?: number, funcDst?: number): any {
     ...
     * @since 4.0.0
     */
    createSeparate (renderer: any, enabled?: boolean, color?: number[], equationRGB?: number, equationAlpha?: number, funcSrcRGB?: number, funcDstRGB?: number, funcSrcAlpha?: number, funcDstAlpha?: number): any {
        const gl = renderer.gl;
        if (enabled === undefined) { enabled = true; }
        if (color === undefined) { color = [ 0, 0, 0, 0 ]; }
