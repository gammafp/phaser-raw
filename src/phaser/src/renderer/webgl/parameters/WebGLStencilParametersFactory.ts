 ...
 * @since 4.0.0
 */
export const WebGLStencilParametersFactory = {
    /**
    ...
    */
    create: function (renderer: any, enabled?: boolean, func?: number, funcRef?: number, funcMask?: number, opFail?: number, opZfail?: number, opZpass?: number, clear?: number): any
    {
