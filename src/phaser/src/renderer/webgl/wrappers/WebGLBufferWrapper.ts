...
export class WebGLBufferWrapper {
    ...
    constructor(renderer: any, dataBuffer: ArrayBuffer, bufferType: number, bufferUsage: number)
    {
        /**
    ...
    destroy(): void
    {
        ...
        this.webGLBuffer = null;
        this.dataBuffer = null as any;
        this.viewF32 = null;
        this.viewU8 = null as any;
        this.viewU16 = null;
        this.viewU32 = null;
        this.renderer = null;
    }
