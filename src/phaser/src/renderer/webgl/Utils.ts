...
export const Utils = {
     ...
     */
    getTintFromFloats: function (r: number, g: number, b: number, a: number): number
    {
        const ur = ((r * 255) | 0) & 0xff;
        const ug = ((g * 255) | 0) & 0xff;
        const ub = ((b * 255) | 0) & 0xff;
     ...
     */
    getTintAppendFloatAlpha: function (rgb: number, a: number): number
    {
        const ua = ((a * 255) | 0) & 0xff;
     ...
     * @return {number} Packed RGBA as Uint32
     */
    getTintAppendFloatAlphaAndSwap: function (rgb: number, a: number): number
    {
        const ur = ((rgb >> 16) | 0) & 0xff;
        const ug = ((rgb >> 8) | 0) & 0xff;
        const ub = (rgb | 0) & 0xff;
        const ua = ((a * 255) | 0) & 0xff;
     ...
     */
    getFloatsFromUintRGB: function (rgb: number): number[]
    {
        const ur = ((rgb >> 16) | 0) & 0xff;
        const ug = ((rgb >> 8) | 0) & 0xff;
        const ub = (rgb | 0) & 0xff;
     ...
     */
    checkShaderMax: function (gl: WebGLRenderingContext, maxTextures: number): number
    {
        ...
        const gpuMax = Math.min(16, gl.getParameter(gl.MAX_TEXTURE_IMAGE_UNITS));
    ...
    updateLightingUniforms: function (
        ...
        vec: any,
        selfShadow?: boolean,
        selfShadowPenumbra?: number,
        selfShadowThreshold?: number
    ): void
    {
        ...
        const ambientColor = lightManager.ambientColor;
