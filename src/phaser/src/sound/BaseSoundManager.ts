 ...
 */
export class BaseSoundManager extends EventEmitter {
     ...
     */
    addAudioSprite(key: string, config?: any): any
    {
    ...
    stopByKey(key: string): number
    {
        ...
        this.getAll(key).forEach(function (sound: any)
        {
    ...
    update(time: number, delta: number): void
    {
        ...
        this.sounds.forEach(function (sound: any)
        {
    ...
    destroy(): void
    {
        ...
        this.sounds.length = 0;
        this.sounds = null as any;
        this.listenerPosition = null as any;
        this.game = null;
    }
     ...
     */
    forEachActiveSound(callback: Function, scope?: any): void
    {
        var _this = this;

        this.sounds.forEach(function (sound: any, index: number)
        {
