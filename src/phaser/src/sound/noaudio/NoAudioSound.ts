...
const returnFalse = function (): boolean
{
    return false;
};

const returnNull = function (): null
{
    return null;
};

const returnThis = function (this: any): any
{
    return this;
};
 ...
 */
export class NoAudioSound extends EventEmitter {
    ...
    destroy(): void
    {
        (BaseSound.prototype.destroy as any).call(this);
    }
