 ...
 */
export const ForEachTile = (callback: (value: Tile, index: number, array: Tile[]) => void, context: any, tileX: number, tileY: number, width: number, height: number, filteringOptions: FilteringOptions, layer: LayerData): void => {
