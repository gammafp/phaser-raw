 ...
 */
export const FilterTiles = (callback: Function, context?: any, tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any, layer?: any): any[] =>
{
    const tiles = GetTilesWithin(tileX, tileY, width, height, filteringOptions, layer);
