 ...
 */
export const CreateFromTiles = (indexes: number | number[], replacements: number | number[] | null, spriteConfig: any, scene: any, camera: any, layer: LayerData): any[] => {
    ...
    var mergeExtras = function (config: any, tile: any, properties: string[])
    {
