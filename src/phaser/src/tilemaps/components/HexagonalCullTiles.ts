...
import { HexagonalCullBounds as CullBounds } from './HexagonalCullBounds';
 ...
 */
export const HexagonalCullTiles = (layer: LayerData, camera: any, outputArray?: Tile[], renderOrder?: number): Tile[] => {
