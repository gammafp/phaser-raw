...
import { SetLayerCollisionIndex } from './SetLayerCollisionIndex';
 ...
 */
export const SetCollisionBetween = (start: number, stop: number, collides: boolean, recalculateFaces: boolean, layer: LayerData, updateLayer?: boolean): void => {
