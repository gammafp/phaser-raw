 ...
 */
export const Copy = (srcTileX: number, srcTileY: number, width: number, height: number, destTileX: number, destTileY: number, recalculateFaces: boolean, layer: LayerData): void => {
    ...
    srcTiles.forEach(function (tile: any)
    {
