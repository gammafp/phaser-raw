 ...
 */
export const WorldToTileXY = (worldX: number, worldY: number, snapToFloor?: boolean, point?: Vector2, camera?: any, layer?: any): Vector2 =>
{
    ...
    let x = worldX / tileWidth;
    let y = worldY / tileHeight;
