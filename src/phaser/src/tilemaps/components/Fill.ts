 ...
 */
export const Fill = (index: number, tileX: number, tileY: number, width: number, height: number, recalculateFaces?: boolean, layer?: any): void =>
{
    const doesIndexCollide = (layer.collideIndexes.indexOf(index) !== -1);
