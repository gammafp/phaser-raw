 ...
 */
export const WeightedRandomize = (tileX: number, tileY: number, width: number, height: number, weightedIndexes: Array<{ index: number | number[]; weight: number }>, layer: LayerData): void => {
