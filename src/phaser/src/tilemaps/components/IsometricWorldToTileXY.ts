 ...
 */
export const IsometricWorldToTileXY = (worldX: number, worldY: number, snapToFloor: boolean, point: Vector2, camera: any, layer: LayerData, originTop?: boolean): Vector2 => {
