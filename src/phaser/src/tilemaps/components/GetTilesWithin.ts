 ...
 */
export const GetTilesWithin = (tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any, layer?: any): any[] =>
{
    ...
    const isNotEmpty = GetFastValue(filteringOptions, 'isNotEmpty', false);
    const isColliding = GetFastValue(filteringOptions, 'isColliding', false);
    const hasInterestingFace = GetFastValue(filteringOptions, 'hasInterestingFace', false);
