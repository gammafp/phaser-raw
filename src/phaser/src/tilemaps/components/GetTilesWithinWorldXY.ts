 ...
 */
export const GetTilesWithinWorldXY = (worldX: number, worldY: number, width: number, height: number, filteringOptions: FilteringOptions, camera: any, layer: LayerData): Tile[] => {
