 ...
 */
export const FindTile = (callback: (value: Tile, index: number, array: Tile[]) => boolean, context: any, tileX: number, tileY: number, width: number, height: number, filteringOptions: FilteringOptions, layer: LayerData): Tile | null => {
