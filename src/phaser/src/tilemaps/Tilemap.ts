 ...
 */
export type TilemapFilterCallback = (value: any, index: number, array: any[]) => boolean;

/**
 * Find callback for objects.
 */
export type TilemapFindCallback = (value: any, index: number, array: any[]) => boolean;
...
export class Tilemap {
     ...
     * failed.
     */
    addTilesetImage(tilesetName?: string, key?: string | null, tileWidth?: number, tileHeight?: number, tileMargin?: number, tileSpacing?: number, gid?: number, tileOffset?: any): Tileset | null
    {
        ...
        const index = this.getTilesetIndex(tilesetName);
     ...
     */
    copy(srcTileX: number, srcTileY: number, width: number, height: number, destTileX: number, destTileY: number, recalculateFaces?: boolean, layer?: any): this | null
    {
     ...
     */
    createBlankLayer(name: string, tileset: any, x?: number, y?: number, width?: number, height?: number, tileWidth?: number, tileHeight?: number): any
    {
        if (x === undefined) { x = 0; }
        if (y === undefined) { y = 0; }
        ...
        const layer = new TilemapLayer(this.scene, this, this.currentLayerIndex, tileset, x, y);
     ...
     */
    createLayer(layerID: string | number, tileset: any, x?: number, y?: number, gpu?: boolean): any
    {
     ...
     */
    createFromObjects(objectLayerName: string, config: any | any[], useTileset?: boolean): any[]
    {
        if (useTileset === undefined) { useTileset = true; }

        const results: any[] = [];

        const objectLayer = this.getObjectLayer(objectLayerName);
        ...
        const objectHelper = new ObjectHelper(useTileset ? this.tilesets : undefined);
        ...
        if (config.sortByY)
        {
            objects.sort(function (a: any, b: any) { return a.y > b.y ? 1 : -1; });
        }

        for (let c = 0; c < config.length; c++)
        {
            const singleConfig = config[c];

            const id = GetFastValue(singleConfig, 'id', null);
            const gid = GetFastValue(singleConfig, 'gid', null);
            const name = GetFastValue(singleConfig, 'name', null);
            const type = GetFastValue(singleConfig, 'type', null);
            ...
            const classType = GetFastValue(singleConfig, 'classType', Sprite);
            const scene = GetFastValue(singleConfig, 'scene', this.scene);
            const container = GetFastValue(singleConfig, 'container', null);
            const texture = GetFastValue(singleConfig, 'key', null);
            const frame = GetFastValue(singleConfig, 'frame', null);

            for (let i = 0; i < toConvert.length; i++)
            {
                obj = toConvert[i];

                const sprite = new classType(scene);
                ...
                {
                    const isometricRatio = this.tileWidth / this.tileHeight;
     ...
     */
    createFromTiles(indexes: number | number[], replacements?: number | number[] | null, spriteConfig?: any, scene?: any, camera?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    fill(index: number, tileX?: number, tileY?: number, width?: number, height?: number, recalculateFaces?: boolean, layer?: any): this | null
    {
     ...
     */
    filterObjects(objectLayer: any, callback: TilemapFilterCallback, context?: any): any
    {
        if (typeof objectLayer === 'string')
        {
            const name = objectLayer;
     ...
     */
    filterTiles(callback: any, context?: any, tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     */
    findByIndex(findIndex: number, skip?: number, reverse?: boolean, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     */
    findObject(objectLayer: any, callback: TilemapFindCallback, context?: any): any
    {
        if (typeof objectLayer === 'string')
        {
            const name = objectLayer;
     ...
     * @return {?Phaser.Tilemaps.Tile} Returns a Tiles, or null if the layer given was invalid.
     */
    findTile(callback: any, context?: any, tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    forEachTile(callback: any, context?: any, tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     */
    getImageIndex(name: string): number | null
    {
     ...
     */
    getIndex(location: any[], name: string): number | null
    {
     ...
     */
    getObjectLayer(name: string): any
    {
        const index = this.getIndex(this.objects, name);
     ...
     */
    getLayerIndex(layer?: any): number | null
    {
        if (layer === undefined)
        {
     ...
     * @return {number} The LayerData index within this.layers.
     */
    getLayerIndexByName(name: string): number | null
    {
     ...
     */
    getTileAt(tileX: number, tileY: number, nonNull?: boolean, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tile} Returns a Tile, or null if the layer given was invalid.
     */
    getTileAtWorldXY(worldX: number, worldY: number, nonNull?: boolean, camera?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tile[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
    getTilesWithin(tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tile[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
    getTilesWithinShape(shape: any, filteringOptions?: any, camera?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tile[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
    getTilesWithinWorldXY(worldX: number, worldY: number, width: number, height: number, filteringOptions?: any, camera?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     */
    getTileset(name: string): Tileset | null
    {
        const index = this.getIndex(this.tilesets, name);
     ...
     */
    getTilesetIndex(name: string): number | null
    {
     ...
     */
    hasTileAt(tileX: number, tileY: number, layer?: any): boolean | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?boolean} Returns a boolean, or null if the layer given was invalid.
     */
    hasTileAtWorldXY(worldX: number, worldY: number, camera?: any, layer?: any): boolean | null
    {
        layer = this.getLayer(layer);
     ...
     */
    putTileAt(tile: number | any, tileX: number, tileY: number, recalculateFaces?: boolean, layer?: any): any
    {
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     * @return {?Phaser.Tilemaps.Tile} Returns a Tile, or null if the layer given was invalid.
     */
    putTileAtWorldXY(tile: number | any, worldX: number, worldY: number, recalculateFaces?: boolean, camera?: any, layer?: any): any
    {
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    putTilesAt(tilesArray: any, tileX: number, tileY: number, recalculateFaces?: boolean, layer?: any): this | null
    {
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    randomize(tileX?: number, tileY?: number, width?: number, height?: number, indexes?: number[], layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    calculateFacesAt(tileX: number, tileY: number, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    calculateFacesWithin(tileX?: number, tileY?: number, width?: number, height?: number, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    removeLayer(layer?: any): this | null
    {
        const index = this.getLayerIndex(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
    destroyLayer(layer?: any): this | null
    {
        const index = this.getLayerIndex(layer);
     ...
     */
    removeTile(tiles: any | any[], replaceIndex?: number, recalculateFaces?: boolean): any[]
    {
     ...
     */
    removeTileAt(tileX: number, tileY: number, replaceWithNull?: boolean, recalculateFaces?: boolean, layer?: any): any
    {
     ...
     * @return {?Phaser.Tilemaps.Tile} Returns a Tile, or null if the layer given was invalid.
     */
    removeTileAtWorldXY(worldX: number, worldY: number, replaceWithNull?: boolean, recalculateFaces?: boolean, camera?: any, layer?: any): any
    {
        if (replaceWithNull === undefined) { replaceWithNull = true; }
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     */
    renderDebug(graphics: any, styleConfig?: any, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     */
    renderDebugFull(graphics: any, styleConfig?: any): this
    {
        const layers = this.layers;
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    replaceByIndex(findIndex: number, newIndex: number, tileX?: number, tileY?: number, width?: number, height?: number, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    setCollision(indexes: number | number[], collides?: boolean, recalculateFaces?: boolean, layer?: any, updateLayer?: boolean): this | null
    {
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    setCollisionBetween(start: number, stop: number, collides?: boolean, recalculateFaces?: boolean, layer?: any): this | null
    {
        if (collides === undefined) { collides = true; }
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    setCollisionByProperty(properties: any, collides?: boolean, recalculateFaces?: boolean, layer?: any): this | null
    {
        if (collides === undefined) { collides = true; }
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    setCollisionByExclusion(indexes: number[], collides?: boolean, recalculateFaces?: boolean, layer?: any): this | null
    {
        if (collides === undefined) { collides = true; }
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    setCollisionFromCollisionGroup(collides?: boolean, recalculateFaces?: boolean, layer?: any): this | null
    {
        if (collides === undefined) { collides = true; }
        if (recalculateFaces === undefined) { recalculateFaces = true; }
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    setTileIndexCallback(indexes: number | number[], callback: any, callbackContext?: any, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    setTileLocationCallback(tileX: number, tileY: number, width: number, height: number, callback: any, callbackContext?: any, layer?: any): this | null
    {
        layer = this.getLayer(layer);
    ...
    setBaseTileSize(tileWidth: number, tileHeight: number): this
    {
        ...
        for (let i = 0; i < this.layers.length; i++)
        {
            ...
            const mapData = this.layers[i].data;
            const mapWidth = this.layers[i].width;
            const mapHeight = this.layers[i].height;
     ...
     * @return {this} This Tilemap object.
     */
    setLayerTileSize(tileWidth: number, tileHeight: number, layer?: any): this
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    shuffle(tileX?: number, tileY?: number, width?: number, height?: number, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    swapByIndex(indexA: number, indexB: number, tileX?: number, tileY?: number, width?: number, height?: number, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     */
    tileToWorldX(tileX: number, camera?: any, layer?: any): number | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?number} Returns a number, or null if the layer given was invalid.
     */
    tileToWorldY(tileY: number, camera?: any, layer?: any): number | null
    {
        layer = this.getLayer(layer);
     ...
     */
    tileToWorldXY(tileX: number, tileY: number, vec2?: any, camera?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     */
    getTileCorners(tileX: number, tileY: number, camera?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
     ...
     * @return {?Phaser.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
    weightedRandomize(weightedIndexes: any[], tileX?: number, tileY?: number, width?: number, height?: number, layer?: any): this | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?number} Returns a number, or null if the layer given was invalid.
     */
    worldToTileX(worldX: number, snapToFloor?: boolean, camera?: any, layer?: any): number | null
    {
        layer = this.getLayer(layer);
     ...
     * @return {?number} Returns a number, or null if the layer given was invalid.
     */
    worldToTileY(worldY: number, snapToFloor?: boolean, camera?: any, layer?: any): number | null
    {
        layer = this.getLayer(layer);
     ...
     */
    worldToTileXY(worldX: number, worldY: number, snapToFloor?: boolean, vec2?: any, camera?: any, layer?: any): any
    {
        layer = this.getLayer(layer);
