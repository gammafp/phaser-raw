 ...
 */
export class TilemapLayer extends TilemapLayerBase {

    static
    {
        Mixin(this, [TilemapLayerRender]);
    }
    ...
    cullPaddingX: number;
    cullPaddingY: number;
    cullCallback: (layer: any, camera: any, culledTiles: any[], renderOrder: number) => any[];
    _renderOrder: number;
    gidMap: any[];

    constructor(scene: any, tilemap: any, layerIndex: number, tileset: any, x?: number, y?: number)
    {
         ...
         * @since 3.50.0
         */
        this.cullCallback = GetCullTilesFunction(this.layer.orientation);
     ...
     * @return {this} This Tilemap Layer object.
     */
    setTint(tint?: number, tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any): this
    {
        if (tint === undefined) { tint = 0xffffff; }

        const tintTile = function (tile: any): void
        {
            tile.tint = tint;
        };
     ...
     * @return {this} This Tilemap Layer object.
     */
    setTintFill(tintFill?: any, tileX?: number, tileY?: number, width?: number, height?: number, filteringOptions?: any): this
    {
