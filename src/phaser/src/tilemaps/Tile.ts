...
export class Tile {
     ...
     */
    getLeft(camera?: any): number
    {
        const tilemapLayer = this.tilemapLayer;

        if (tilemapLayer)
        {
            const point = tilemapLayer.tileToWorldXY(this.x, this.y, undefined, camera);
     ...
     */
    getBounds(camera?: any, output?: any): any
    {
     ...
     * @return {this} This Tile object instance.
     */
    resetCollision(recalculateFaces: boolean = true): this
    {
        this.collideLeft = false;
        this.collideRight = false;
        this.collideUp = false;
     ...
     * @return {this} This Tile object instance.
     */
    setCollision(left: boolean, right?: boolean, up?: boolean, down?: boolean, recalculateFaces: boolean = true): this
    {
     ...
     * @return {this} This Tile object instance.
     */
    setCollisionCallback(callback: any, context: any): this
    {
        if (callback === null)
        {
            this.collisionCallback = undefined;
    ...
    updatePixelXY(): this
    {
        const orientation = this.layer.orientation;
        ...
        {
            const staggerAxis = this.layer.staggerAxis;
            const staggerIndex = this.layer.staggerIndex;
            const len = this.layer.hexSideLength;
            let rowWidth: number;
    ...
    get hasInterestingFace(): boolean
    {
