...
export class ObjectHelper {
     ...
     */
    getTypeIncludingTile(obj: any): string | undefined
    {
        ...
        const tileset = this.gids[obj.gid];
        ...
        const tileData = tileset.getTileData(obj.gid);
     ...
     */
    setTextureAndFrame(sprite: any, key: any, frame: any, obj: any): void
    {
     ...
     */
    setPropertiesFromTiledObject(sprite: any, obj: any): void
    {
     ...
     */
    setFromJSON(sprite: any, properties: any): void
    {
        if (!properties)
        {
            return;
