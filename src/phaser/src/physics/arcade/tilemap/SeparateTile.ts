 ...
 */
export const SeparateTile = function (i: number, body: any, tile: any, tileWorldRect: any, tilemapLayer: any, tileBias: number, isLayer: boolean): boolean
{
    const tileLeft = tileWorldRect.left;
    const tileTop = tileWorldRect.top;
    const tileRight = tileWorldRect.right;
    const tileBottom = tileWorldRect.bottom;
    let faceHorizontal = tile.faceLeft || tile.faceRight;
    let faceVertical = tile.faceTop || tile.faceBottom;
