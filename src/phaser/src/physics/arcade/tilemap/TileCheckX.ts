...
const ProcessTileSeparationX = require('./ProcessTileSeparationX');

export const TileCheckX = (body: any, tile: any, tileLeft: number, tileRight: number, tileBias: number, isLayer: boolean): number =>
{
    var ox = 0;
