 ...
 */
export const PathFollowerFactory = function (this: any, path: any, x: number, y: number, key: string | any, frame?: string | number): PathFollower {
    const sprite = new PathFollower(this.scene, path, x, y, key, frame);
...
GameObjectFactory.register('follower', PathFollowerFactory);
