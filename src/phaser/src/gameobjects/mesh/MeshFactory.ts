...
{
    GameObjectFactory.register('mesh', function (this: any, x?: number, y?: number, texture?: string | any, frame?: string | number, vertices?: number[], uvs?: number[], indicies?: number[], containsZ?: boolean, normals?: number[], colors?: number | number[], alphas?: number | number[]): Mesh
    {
