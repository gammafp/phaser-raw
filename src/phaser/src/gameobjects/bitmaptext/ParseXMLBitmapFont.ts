 ...
 */
function getValue (node: Element, attribute: string): number
{
 ...
 */
export const ParseXMLBitmapFont = function (xml: XMLDocument, frame: any, xSpacing?: number, ySpacing?: number, texture?: any): any
{
    ...
    if (adjustForTrim)
    {
        trimX = frame.data.spriteSourceSize.x;
        trimY = frame.data.spriteSourceSize.y;
    }
