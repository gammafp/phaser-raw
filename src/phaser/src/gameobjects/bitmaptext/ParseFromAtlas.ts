 ...
 */
export const ParseFromAtlas = function (scene: any, fontName: string, textureKey: string, frameKey: string, xmlKey: string, xSpacing?: number, ySpacing?: number): boolean
{
