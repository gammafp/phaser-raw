...
import { BitmapTextRender } from './BitmapTextRender';

export interface BitmapText extends Alpha, BlendMode, Depth, GetBounds, Mask, Origin, Pipeline, PostPipeline, ScrollFactor, Texture, Tint, Transform, Visible {}
