 ...
 */
export const BatchChar = function (drawingContext: any, submitterNode: any, src: any, char: any, glyph: any, offsetX: number, offsetY: number, calcMatrix: any, tintData: any): void
{
