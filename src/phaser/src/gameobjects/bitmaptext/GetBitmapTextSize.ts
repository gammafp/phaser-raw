 ...
 */
export const GetBitmapTextSize = function (src?: any, round?: boolean, updateOrigin?: boolean, out?: any): any
{
    ...
    var kerningOffset: number;

    // Measure the width of the text
    var measureTextWidth = function (text: string, fontData: any): number
    {
        var width = 0;
