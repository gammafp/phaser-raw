 ...
 *
 * @return {Phaser.Math.Vector2[]} An array of Vector2 pertaining to the points around the circumference of the ellipse.
 */
export const GetPoints = (ellipse: any, quantity: number, stepRate?: number, out?: Vector2[]): Vector2[] =>
{
