...
export class BaseTweenData {
    ...
    constructor(tween: any, targetIndex: number, delay: any, duration: number, yoyo: boolean, hold: number, repeat: number, repeatDelay: number, flipX: boolean, flipY: boolean)
    {
        /**
