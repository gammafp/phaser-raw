...
export class Controller {
    ...
    paddingOverride: Rectangle | null;
    currentPadding: Rectangle;
    allowBaseDraw: boolean;
    ignoreDestroy: boolean;

    constructor(camera: any, renderNode: string)
    {
        /**
     ...
     */
    setPaddingOverride(left?: number | null, top?: number, right?: number, bottom?: number): this
    {
        if (left === null)
        {
