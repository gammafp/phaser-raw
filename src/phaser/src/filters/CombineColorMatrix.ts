 ...
 */
export class CombineColorMatrix extends Controller {
    glTexture: any;
    colorMatrixSelf: ColorMatrix | null;
    colorMatrixTransfer: ColorMatrix | null;
    additions: number[];
    multiplications: number[];

    constructor(camera: any, texture?: any)
    {
        super(camera, 'FilterCombineColorMatrix');
