...
export class Glow extends Controller {
    ...
    constructor(camera: any, color?: number, outerStrength: number = 4, innerStrength: number = 0, scale: number = 1, knockout: boolean = false, quality?: number, distance?: number)
    {
