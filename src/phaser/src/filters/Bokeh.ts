...
export class Bokeh extends Controller {
    ...
    constructor(camera: any, radius: number = 0.5, amount: number = 1, contrast: number = 0.2, isTiltShift: boolean = false, blurX: number = 1, blurY: number = 1, strength: number = 1)
    {
