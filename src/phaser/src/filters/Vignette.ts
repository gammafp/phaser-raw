...
export class Vignette extends Controller {
    ...
    constructor(camera: any, x: number = 0.5, y: number = 0.5, radius: number = 0.5, strength: number = 0.5, color: any = 0x000000, blendMode: number = 0)
    {
        super(camera, 'FilterVignette');
