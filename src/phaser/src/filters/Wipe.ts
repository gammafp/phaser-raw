...
export class Wipe extends Controller {
    ...
    constructor(camera: any, wipeWidth: number = 0.1, direction?: number, axis?: number, reveal?: number, wipeTexture?: any)
    {
        super(camera, 'FilterWipe');
     ...
     * @returns {this} - This filter instance.
     */
    setTexture(texture: any = '__DEFAULT'): this
    {
