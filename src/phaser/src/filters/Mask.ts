 ...
 */
export class Mask extends Controller {
    glTexture: any;
    private _dynamicTexture: any;
    maskGameObject: any;
    invert: boolean;
    autoUpdate: boolean;
    needsUpdate: boolean;
    ...
    constructor(camera: any, mask: any = '__WHITE', invert: boolean = false, viewCamera?: any, viewTransform?: 'local' | 'world', scaleFactor: number = 1)
    {
