 ...
 */
export class ImageLight extends Controller {
    normalGlTexture: any;
    environmentGlTexture: any;
    viewMatrix: Matrix4;
    modelRotation: number;
    modelRotationSource: any;
    bulge: number;
    colorFactor: [number, number, number];
    private _tempMatrix: any;
    private _tempParentMatrix: any;

    constructor(camera: any, config: any = {})
    {
        super(camera, 'FilterImageLight');
     ...
     */
    setEnvironmentMap(texture: any): this
    {
     ...
     * @returns {this} This ImageLight instance.
     */
    setNormalMapFromGameObject(gameObject: any): this
    {
