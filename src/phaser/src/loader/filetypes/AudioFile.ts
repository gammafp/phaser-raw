...
import { HTML5AudioFile } from './HTML5AudioFile';
...
export class AudioFile extends File {
    ...
    constructor(loader: any, key: any, urlConfig?: any, xhrSettings?: any, audioContext?: any)
    {
    ...
    static create(loader: any, key: any, urls?: any, config?: any, xhrSettings?: any): any
    {
        const game = loader.systems.game;
        ...
        const urlConfig = AudioFile.getAudioURL(game, urls);
    ...
    static getAudioURL(game: any, urls: any): any
    {
        ...
        for (let i = 0; i < urls.length; i++)
        {
            ...
            const audioTypeMatch = url.match(/\.([a-zA-Z0-9]+)($|\?)/);

            const audioType = GetFastValue(urls[i], 'type', (audioTypeMatch) ? audioTypeMatch[1] : '').toLowerCase();
 ...
 */
FileTypesManager.register('audio', function (key: any, urls?: any, config?: any, xhrSettings?: any): any
{
