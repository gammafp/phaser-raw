 ...
 */
export class PackFile extends JSONFile {

    //  url can either be a string, in which case it is treated like a proper url, or an object, in which case it is treated as a ready-made JS Object
    //  dataKey allows you to pluck a specific object out of the JSON and put just that into the cache, rather than the whole thing

    constructor(loader: any, key: string | Record<string, any>, url?: string | any, xhrSettings?: any, dataKey?: string)
    {
 ...
 */
FileTypesManager.register('pack', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string, dataKey?: string, xhrSettings?: any): any
{
