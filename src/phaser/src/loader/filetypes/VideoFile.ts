...
export class VideoFile extends File {
    ...
    constructor(loader: any, key: any, url?: any, noAudio?: boolean)
    {
        ...
        const urlConfig = loader.systems.game.device.video.getVideoURL(url);
 ...
 */
FileTypesManager.register('video', function (key: any, urls?: any, noAudio?: boolean): any
{
