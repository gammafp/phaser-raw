 ...
 */
export class MultiScriptFile extends MultiFile {

    constructor(loader: any, key: string | Record<string, any>, url?: string | string[], xhrSettings?: any)
    {
        ...
        {
            const scriptFile = new ScriptFile(loader, {
                key: (key as string) + '_' + i.toString(),
                url: url[i],
                extension: extension,
        ...
        super(loader, 'scripts', key as string, files);
    }
 ...
 */
FileTypesManager.register('scripts', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string[], xhrSettings?: any): any
{
    let multifile: MultiScriptFile;
