 ...
 */
export class TilemapCSVFile extends File {

    tilemapFormat: number;

    constructor(loader: any, key: string | Record<string, any>, url?: string, xhrSettings?: any)
    {
    ...
    addToCache(): void
    {
        const tiledata = { format: this.tilemapFormat, data: this.data };
 ...
 */
FileTypesManager.register('tilemapCSV', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string, xhrSettings?: any): any
{
