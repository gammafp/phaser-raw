 ...
 */
export class HTML5AudioFile extends File {
    ...
    constructor(loader: any, key: any, urlConfig?: any, audioConfig?: any)
    {
    ...
    load(): void
    {
        ...
        const instances = (this.config && this.config.instances) || 1;
