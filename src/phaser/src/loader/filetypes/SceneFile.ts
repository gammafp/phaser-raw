 ...
 */
export class SceneFile extends File {
    ...
    addToCache(): void
    {
        const code = this.data.concat('(function(){\n' + 'return new ' + this.key + '();\n' + '}).call(this);');
 ...
 */
FileTypesManager.register('sceneFile', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string, xhrSettings?: any): any
{
