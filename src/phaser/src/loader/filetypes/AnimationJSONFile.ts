...
export class AnimationJSONFile extends JSONFile {
    ...
    constructor//  url can either be a string, in which case it is treated like a proper url, or an object, in which case it is treated as a ready-made JS Object
