 ...
 */
export class AsepriteFile extends MultiFile {

    constructor(loader: any, key: string | Record<string, any>, textureURL?: string | string[], atlasURL?: string | Record<string, any>, textureXhrSettings?: any, atlasXhrSettings?: any)
    {
        let image: ImageFile;
        let data: JSONFile;
        ...
        if (image.linkFile)
        {
            ...
            super(loader, 'atlasjson', key as string, [ image, data, image.linkFile ]);
        }
        else
        {
            super(loader, 'atlasjson', key as string, [ image, data ]);
        }
    }
 ...
 */
FileTypesManager.register('aseprite', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, textureURL?: string | string[], atlasURL?: string | Record<string, any>, textureXhrSettings?: any, atlasXhrSettings?: any): any
{
    let multifile: AsepriteFile;
