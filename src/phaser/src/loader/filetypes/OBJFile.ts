 ...
 */
export class OBJFile extends MultiFile {

    constructor(loader: any, key: string | Record<string, any>, objURL?: string, matURL?: string, flipUV?: boolean, xhrSettings?: any)
    {
        let obj: TextFile;
        let mat: TextFile | undefined;

        const cache = loader.cacheManager.obj;
        ...
        super(loader, 'obj', key as string, [ obj, mat ]);
    }
    ...
    addToCache(): void
    {
        ...
        {
            const obj = this.files[0];
            const mat = this.files[1];

            const objData = ParseObj(obj.data, obj.config.flipUV);
 ...
 */
FileTypesManager.register('obj', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, objURL?: string, matURL?: string, flipUVs?: boolean, xhrSettings?: any): any
{
    let multifile: OBJFile;
