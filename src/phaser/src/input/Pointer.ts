...
export class Pointer {
    manager: any;
    id: number;
    event: TouchEvent | MouseEvent | WheelEvent | undefined;
    downElement: any;
    upElement: any;
    camera: any;
    button: number;
    ...
    constructor(manager: any, id: number)
    {
        /**
     ...
     */
    touchstart(touch: Touch, event: TouchEvent): void
    {
        if (touch['pointerId'])
        {
     ...
     * @param {TouchEvent} event - The full Touch Event.
     */
    touchmove(touch: Touch, event: TouchEvent): void
    {
        this.event = event;
     ...
     * @param {TouchEvent} event - The full Touch Event.
     */
    touchend(touch: Touch, event: TouchEvent): void
    {
        this.buttons = 0;
     ...
     * @param {TouchEvent} event - The full Touch Event.
     */
    touchcancel(touch: Touch, event: TouchEvent): void
    {
        this.buttons = 0;
     ...
     */
    getInterpolatedPosition(steps: number = 10, out: any[] = []): any[]
    {
