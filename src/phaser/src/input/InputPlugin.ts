...
export class InputPlugin extends EventEmitter {
    ...
    bounds: any;
    _pointerDownCallback: Function;
    _pointerMoveCallback: Function;
    _pointerUpCallback: Function;
    _pointerOverCallback: Function;
    _pointerOutCallback: Function;
    _pointerWheelCallback: Function;
    _dragDistanceThreshold: number;
    _dragTimeThreshold: number;
    _drag: Map<any, any>;
    _over: Map<any, any>;
    _validTypes: string[];
