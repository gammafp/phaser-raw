 ...
 *
 * This event is dispatched by the Keyboard Plugin when a [Key Combo]{@link Phaser.Input.Keyboard.KeyCombo} matches.
 *
 ...
 *
 * this.input.keyboard.on('keycombomatch', listener);
 * ```
 *
 ...
 */
export const COMBO_MATCH = 'keycombomatch';
