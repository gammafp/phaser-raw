 ...
 */
export const CreatePixelPerfectHandler = (textureManager: any, alphaTolerance: number): Function =>
{
    return function (hitArea: any, x: number, y: number, gameObject: any): boolean
    {
