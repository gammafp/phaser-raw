...
const InputEvents = require('../events');
 ...
 */
export class GamepadPlugin extends EventEmitter {
    /**
    ...
    constructor(sceneInputPlugin: any)
    {
        ...
        this.gamepads = [];
        this.queue = [];
        this.onGamepadHandler = undefined;
        this._pad1 = undefined;
        this._pad2 = undefined;
        this._pad3 = undefined;
        this._pad4 = undefined;
        ...
        else
        {
            ...
            for (let i = 0; i < connectedPads.length; i++)
            {
                ...
                if (!currentPad)
                {
                    ...
                    const newPad = new Gamepad(this, livePad as any);
                ...
                else if (currentPad.id !== id)
                {
                    ...
                    currentPads[index] = new Gamepad(this, livePad as any);
                }
                else
                {
