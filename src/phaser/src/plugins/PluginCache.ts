...
export const PluginCache = {
     ...
     */
    register: (key: string, plugin: any, mapping: string, custom: boolean = false): void =>
    {
     ...
     */
    registerCustom: (key: string, plugin: any, mapping: string, data?: any): void =>
    {
