...
if (!folderArg) {
    console.error('❌ Usage: bun scripts/_legacy/check-folder-mixins.ts <folder-path>');
    console.error('   Example: bun scripts/_legacy/check-folder-mixins.ts src/phaser/src/curves');
    process.exit(1);
}
