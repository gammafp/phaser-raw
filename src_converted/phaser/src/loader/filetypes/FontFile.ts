 ...
 */
export class FontFile extends File {

    constructor(loader: any, key: string | Record<string, any>, url?: string, format: string = 'truetype', descriptors?: FontFaceDescriptors, xhrSettings?: any)
    {
        let extension: string = 'ttf';
    ...
    onProcess(): void
    {
        ...
        let font: FontFace;
        const key = this.key;
        const source = 'url(' + this.src + ') format("' + this.data.format + '")';
 ...
 */
FileTypesManager.register('font', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string, format?: string, descriptors?: FontFaceDescriptors, xhrSettings?: any): any
{
