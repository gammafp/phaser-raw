 ...
 */
export class PluginFile extends File {

    constructor(loader: any, key: string | Record<string, any>, url?: PluginUrlOrClass, start: boolean = false, mapping?: string, xhrSettings?: any)
    {
    ...
    onProcess(): void
    {
        ...
        const start = GetFastValue(config, 'start', false);
        const mapping = GetFastValue(config, 'mapping', null);
        ...
        else
        {
            ...
            const plugin = pluginManager.install(this.key, (window as any)[this.key], start, mapping);
 ...
 */
FileTypesManager.register('plugin', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: PluginUrlOrClass, start?: boolean, mapping?: string, xhrSettings?: any): any
{
