 ...
 */
export class TilemapJSONFile extends JSONFile {

    constructor(loader: any, key: string | Record<string, any>, url?: string | Record<string, any>, xhrSettings?: any)
    {
    ...
    addToCache(): void
    {
        const tiledata = { format: TILEMAP_FORMATS.TILED_JSON, data: this.data };
 ...
 */
FileTypesManager.register('tilemapTiledJSON', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string | Record<string, any>, xhrSettings?: any): any
{
