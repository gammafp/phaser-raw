...
export class ScriptFile extends File {
    ...
    constructor(loader: any, key: string | Record<string, any>, url?: string, type: ScriptType = 'script', xhrSettings?: any)
    {
 ...
 */
FileTypesManager.register('script', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string, type?: ScriptType, xhrSettings?: any): any
{
