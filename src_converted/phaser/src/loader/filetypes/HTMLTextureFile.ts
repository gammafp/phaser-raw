 ...
 */
export class HTMLTextureFile extends File {

    constructor(loader: any, key: string | Record<string, any>, url?: string, width: number = 512, height: number = 512, xhrSettings?: any)
    {
 ...
 */
FileTypesManager.register('htmlTexture', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string, width?: number, height?: number, xhrSettings?: any): any
{
