...
import { BROWSER_DEVICE } from './Browser';
...
const init = () =>
{
    ...
    if ('onwheel' in window || (BROWSER_DEVICE.ie && 'WheelEvent' in window))
    {
    ...
    else if (BROWSER_DEVICE.firefox && 'MouseScrollEvent' in window)
    {
...
export const INPUT_DEVICE = init();
