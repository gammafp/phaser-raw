 ...
 */
export class AtlasXMLFile extends MultiFile {
    ...
    constructor(loader: any, key: string | Record<string, any>, textureURL?: string | string[], atlasURL?: string, textureXhrSettings?: any, atlasXhrSettings?: any)
    {
        ...
        if (image.linkFile)
        {
            ...
            super(loader, 'atlasxml', key as string, [ image, data, image.linkFile ]);
        }
        else
        {
            super(loader, 'atlasxml', key as string, [ image, data ]);
        }
    }
 ...
 */
FileTypesManager.register('atlasXML', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, textureURL?: string | string[], atlasURL?: string, textureXhrSettings?: any, atlasXhrSettings?: any): any
{
    let multifile: AtlasXMLFile;
