...
export class BinaryFile extends File {
    ...
    constructor(loader: any, key: any, url?: any, xhrSettings?: any, dataType?: any)
    {
    ...
    onProcess(): void
    {
        ...
        const ctor = this.config.dataType;
 ...
 */
FileTypesManager.register('binary', function (key: any, url?: any, dataType?: any, xhrSettings?: any): any
{
