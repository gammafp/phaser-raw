...
type PluginUrlOrClass = string | Function;
 ...
 */
export class ScenePluginFile extends File {

    constructor(loader: any, key: string | Record<string, any>, url?: PluginUrlOrClass, systemKey?: string, sceneKey?: string, xhrSettings?: any)
    {
    ...
    onProcess(): void
    {
        const pluginManager = this.loader.systems.plugins;
        const config = this.config;

        const key = this.key;
        const systemKey = GetFastValue(config, 'systemKey', key);
        const sceneKey = GetFastValue(config, 'sceneKey', key);
        ...
        else
        {
            ...
            pluginManager.installScenePlugin(systemKey, (window as any)[this.key], sceneKey, this.loader.scene, true);
        }
 ...
 */
FileTypesManager.register('scenePlugin', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: PluginUrlOrClass, systemKey?: string, sceneKey?: string, xhrSettings?: any): any
{
