 ...
 */
export class TilemapImpactFile extends JSONFile {
    ...
    addToCache(): void
    {
        const tiledata = { format: TILEMAP_FORMATS.WELTMEISTER, data: this.data };
 ...
 */
FileTypesManager.register('tilemapImpact', function (this: any, key: string | Record<string, any> | Array<Record<string, any>>, url?: string, xhrSettings?: any): any
{
