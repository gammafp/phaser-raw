...
export class ImageFile extends File {
    ...
    useImageElementLoad: boolean;

    constructor(loader: any, key: any, url?: any, xhrSettings?: any, frameConfig?: any)
    {
        let extension: string = 'png';
        let normalMapURL: any;
        ...
        if (normalMapURL)
        {
            const normalMap = new ImageFile(loader, this.key, normalMapURL, xhrSettings, frameConfig);
 ...
 */
FileTypesManager.register('image', function (key: any, url?: any, xhrSettings?: any): any
{
