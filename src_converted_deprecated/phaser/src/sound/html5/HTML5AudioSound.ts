 ...
 */
export class HTML5AudioSound extends BaseSound {
    ...
    constructor(manager: any, key: string, config?: any)
    {
        ...
        const tags = manager.game.cache.audio.get(key);
        ...
        const tempTags = tags;
        const tempDuration = tempTags[0].duration;
    ...
    {
        if ((this.manager as any).isLocked(this, 'play', [ markerName, config ]))
        {
            return false;
        }

        if (!super.play(markerName, config))
        {
            return false;
        }
    ...
    pause(): boolean
    {
        if ((this.manager as any).isLocked(this, 'pause'))
        {
            return false;
        }
    ...
    resume(): boolean
    {
        if ((this.manager as any).isLocked(this, 'resume'))
        {
            return false;
        }
    ...
    stop(): boolean
    {
        if ((this.manager as any).isLocked(this, 'stop'))
        {
            return false;
        }
    ...
    pickAudioTag(): boolean
    {
        ...
        if (!(this.manager as any).override)
        {
            return false;
        }
        ...
        (this.manager as any).forEachActiveSound(function (this: HTML5AudioSound, sound: any)
        {
        ...
        otherSounds.sort(function (a1: any, a2: any)
        {
            if (a1.loop === a2.loop)
            {
                // sort by progress
    ...
    playCatchPromise(): void
    {
        ...
        if (playPromise)
        {
            ...
            playPromise.catch(function (reason: any)
            {
                console.warn(reason);
            });
        }
    ...
    update(time?: number, delta?: number): void
    {
        ...
        if (this.startTime > 0)
        {
            if (this.startTime < time! - (this.manager as any).audioPlayDelay)
            {
        ...
        {
            if (currentTime >= endTime - (this.manager as any).loopEndOffset)
            {
    ...
    set mute(value: boolean)
    {
        ...
        if ((this.manager as any).isLocked(this, 'mute', value))
        {
            return;
        }
    ...
    set volume(value: number)
    {
        ...
        if ((this.manager as any).isLocked(this, 'volume', value))
        {
            return;
        }
    ...
    set rate(value: number)
    {
        ...
        if ((this.manager as any).isLocked(this, Events.RATE, value))
        {
            return;
        }
        else
    ...
    set detune(value: number)
    {
        ...
        if ((this.manager as any).isLocked(this, Events.DETUNE, value))
        {
            return;
        }
        else
    ...
    {
        if ((this.manager as any).isLocked(this, 'seek', value))
        {
            return;
        }
    ...
    set loop(value: boolean)
    {
        ...
        if ((this.manager as any).isLocked(this, 'loop', value))
        {
            return;
        }
