...
import { HTML5AudioSound } from './HTML5AudioSound';
 ...
 */
export class HTML5AudioSoundManager extends BaseSoundManager {
     ...
     * @since 3.0.0
     */
    onBlurPausedSounds: HTML5AudioSound[];
     ...
     */
    add(key: string, config?: any): HTML5AudioSound
    {
    ...
    unlock(): void
    {
        ...
        this.game.cache.audio.entries.each(function (key: string, tags: any)
        {
        ...
        var unlock = function ()
        {
            ...
            _this.game.cache.audio.entries.each(function (key: string, tags: any)
            {
                for (var i = 0; i < tags.length; i++)
                {
                    var tag = tags[i];
        ...
        this.once(Events.UNLOCKED, function (this: HTML5AudioSoundManager)
        {
            this.forEachActiveSound(function (sound: any)
            {
    ...
    onBlur(): void
    {
        this.forEachActiveSound(function (this: HTML5AudioSoundManager, sound: any)
        {
            if (sound.isPlaying)
            {
    ...
    onFocus(): void
    {
        this.onBlurPausedSounds.forEach(function (sound: any)
        {
            sound.onFocus();
        });
    ...
    destroy(): void
    {
        ...
        this.onBlurPausedSounds.length = 0;
        this.onBlurPausedSounds = null as any;
    }
     ...
     */
    isLocked(sound: any, prop: string, value?: any): boolean
    {
