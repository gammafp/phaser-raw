 ...
 */
export class Gradient extends Controller {
    ...
    constructor(gameObject: any, color1?: number, color2?: number, alpha: number = 0.2, fromX: number = 0, fromY: number = 0, toX: number = 0, toY: number = 1, size: number = 0)
    {
        super(FX_CONST.GRADIENT, gameObject);
